...
public class AlertExpListAdapter extends BaseExpandableListAdapter {

    public ArrayList<AlertParentItem> parentItems = new ArrayList<AlertParentItem>(); //부모 리스트를 담을 배열

    public void addItem(AlertParentItem item) {
        parentItems.add(item);
    }

    public ArrayList<ArrayList<AlertChildItem>> childItems; //자식 리스트를 담을 배열
    ...
    //리스트 아이템 반환
    @Override
    public AlertParentItem getGroup(int groupPosition) {
        return parentItems.get(groupPosition);
    }

    @Override
    public AlertChildItem getChild(int groupPosition, int childPosition) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = inflater.inflate(R.layout.exp_parent_item1, parent, false);
        }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            v = inflater.inflate(R.layout.exp_child_item1, parent, false);
        }
    ...
    //리스트에 새로운 아이템을 추가
    public void addItem(int groupPosition, AlertChildItem item) {
